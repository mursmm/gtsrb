...
'''
'''
#try different augmentation to reduce the training loss
train_transform = transforms.Compose([
...
'''
#Create an instance of pre-trained ResNet-50
numClasses = 43
model = models.resnet50(weights='ResNet50_Weights.DEFAULT')
model.fc = nn.Linear(model.fc.in_features, numClasses)

#Create an instance of pre-trained VGG19
numClasses = 43
...
#Create an instance of pre-trained ViT
numClasses = 43
...
'''        
#Create an instance of pre-trained ConvNext
numClasses = 43
model = models.convnext_large(weights='IMAGENET1K_V1')
#print(model)
modelclassifier = nn.Sequential(
    nn.LayerNorm(1024),
    nn.Flatten(),
    nn.Linear(in_features=1024, out_features=1024)  # Adjust the input size to 1024
)
